...
-   Document your observations here.
    -   6-person families seem to have the widest confidence intervals
        and 2-person families the most narrow, nearly across the board.
        This could be caused by underlying variance or a small sample
        size. Intuitively, I believe that there is likely a much smaller
        sample size for 6-person families than 2-person families.
...
-   Can you confidently distinguish between household incomes in Suffolk
    ...
    -   No, I cannot confidently distinguish between household incomes
        in Suffolk county, because the confidence intervals of the
        various household sizes overlap, making the medians
...
-   What *overall* trend do you see between `SE` and population? Why
    ...
    -   I see the trend that the larger the population of the county,
        ...
        populations provide more and more data-points (assuming the
        sample is proportional to the population size), bringing
