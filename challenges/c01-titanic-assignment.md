...
- I also notice that the lower the class, the more surviving women, and
  the higher the class, the more surviving men. I want to look at the
  data for all the souls on board to see if this is significant or just
  the breakdown of the passengers.
