...
-   The data is very crowded, I imagine once there is more
    differentiation between the data points it will be difficult to make
...
-   I kept price and carat on the axes because putting a non-continuous
    value attribute (like `cut`) on either axis made the data into a
    weird set of bars.
