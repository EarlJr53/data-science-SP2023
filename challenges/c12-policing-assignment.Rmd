...
-   stop detail categories:
    ...
    -   reason for stop
    -   outcome
-   Exploration could include relationship between variables in
    different categories, such as subject demographics and stop details.
...
-   How does controlling for found contraband affect the `subject_race`
    ...
    -   When there is *not* contraband found, Hispanic subjects are
        still the most likely to be arrested, but black subjects appear
        to be less likely than white subjects. However, when calculating
        a 99% confidence interval for black subjects, the CI does
        intersect zero, implying that this observation is not
        significant. The CI for hispanic subject is still significant,
        however.
