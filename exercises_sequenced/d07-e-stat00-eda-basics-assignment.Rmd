...
**Observations**: - This hypothesis seems to be incorrect. There are the
most "Ideal" diamonds by far, more than all other categories.
...
**Observations**: - This hypothesis is mostly inconclusive based on this
plot. It seems that all cuts have the same range of price, seeming to
disprove the hypothesis. However, it is difficult with this
visualization to tell the frequency with which different prices appear
in each cut. So it may be the case that the Ideal cut skews to the more
expensive side. A boxplot might be the correct choice here.
...
**Observations**: - This plot seems to largely disprove Hypothesis 2, as
the Ideal cut seems to actually be the least expensive on average.
...
**Observations**: - This graph does seem to back up the "carat over cut"
hypothesis, since the Fair cut is a higher average carat value than any
of the other cut categories.
