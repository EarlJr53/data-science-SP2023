...
diamonds %>%
  ...
  mutate(carat_cut = cut_number(carat, 5)) %>%
...
-   The trend in median increasingly curves upward, in quite a smooth
    fashion.
-   The quantiles also curve in a similar way to the median, but the
    higher the carat, the more spread out the quantiles are.
-   
